...
public class History extends AppCompatActivity {
    ...
    private void initData () {
        ...
        Call<ServerResponse> call = service.fetchOrder ( id );
...
//                    Log.e ( TAG , String.valueOf ( serverResponse.getOrders () ) );
                    historyList.addAll ( serverResponse.getOrders ( ) );
